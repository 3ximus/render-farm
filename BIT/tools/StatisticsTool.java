    ...
    public static synchronized void printDynamic(String foo)
		{
			...
			try {
				filestream = new PrintStream(new File("log.txt"));
				filestream.println("Dynamic information summary:");
				filestream.println("Number of methods:      " + dyn_method_count);
				filestream.println("Number of basic blocks: " + dyn_bb_count);
				filestream.println("Number of instructions: " + dyn_instr_count);
				...
				filestream.println("Average number of instructions per basic block: " + instr_per_bb);
				filestream.println("Average number of instructions per method:      " + instr_per_method);
				filestream.println("Average number of basic blocks per method:      " + bb_per_method);
